...
export var Input = forwardRef(function (props, ref) {
    ...
    return (React.createElement("div", { className: classes, style: style },
        prepend && React.createElement("div", { className: "modric-input-group-prepend" }, prepend),
        icon && (React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-".concat(icon) }))),
        React.createElement("input", __assign({ type: "text", ref: ref, className: "input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "modric-input-group-append" }, append)));
});
