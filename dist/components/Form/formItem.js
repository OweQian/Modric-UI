...
export var FormItem = function (props) {
    var _a = props, name = _a.name, label = _a.label, children = _a.children, valuePropName = _a.valuePropName, trigger = _a.trigger, getValueFromEvent = _a.getValueFromEvent, rules = _a.rules, validateTrigger = _a.validateTrigger;
    ...
    useEffect(function () {
        ...
        dispatch({
            type: 'addField',
            name: name,
            value: { label: label, name: name, value: value, rules: rules || [], errors: [], isValid: true }
        });
    }, []);
    // 获取store对应的value
    ...
    return (React.createElement("div", { className: rowClass },
        ...
        React.createElement("div", { className: "form-item" },
            ...
            hasError && (React.createElement("div", { className: "form-item-explain" },
