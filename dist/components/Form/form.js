...
export var Form = React.forwardRef(function (props, ref) {
    var name = props.name, initialValues = props.initialValues, children = props.children, onFinish = props.onFinish, onFinishFailed = props.onFinishFailed;
    ...
    return (React.createElement("form", { className: "form", name: name, onSubmit: submitForm },
